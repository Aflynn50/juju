...
const fakeCharmUUID1 = "fake-charm-uuid-1"
const fakeCharmUUID2 = "fake-charm-uuid-2"
...
VALUES (?, ?, 0, ?, ?, ?, ?, ?, ?, ?)
`, charmRelationUUID, charmUUID, r.Name, r.Name, s.RoleID(r.Role), r.Interface, r.Optional, r.Limit, s.ScopeID(r.Scope))
}

// RoleID returns the ID used in the database for the given charm role. This
// reflects the contents of the charm_relation_role table.
func (s *relationSuite) RoleID(role internalcharm.RelationRole) int {
...
// ScopeID returns the ID used in the database for the given charm scope. This
// reflects the contents of the charm_relation_scope table.
func (s *relationSuite) ScopeID(role internalcharm.RelationScope) int {
