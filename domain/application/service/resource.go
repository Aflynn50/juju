...
type ResourceState interface {
	...
	GetApplicationResourceID(ctx context.Context, args resource.GetApplicationResourceIDArgs) (resources.UUID, error)

	// ListResources returns the list of resources for the given application.
	ListResources(ctx context.Context, applicationID application.ID) (resource.ApplicationResources, error)

	// GetResource returns the identified resource.
	GetResource(ctx context.Context, resourceID resources.UUID) (resource.Resource, error)
	...
	OpenApplicationResource(ctx context.Context, resourceID resources.UUID) (resource.Resource, error)
	...
	OpenUnitResource(ctx context.Context, resourceID resources.UUID, unitID coreunit.UUID) (resource.Resource, error)
...
// GetApplicationResourceID returns the UUID of the application resource specified by
...
//     the args.
//   - errors.NotValid is returned if the application UUID is not valid.
