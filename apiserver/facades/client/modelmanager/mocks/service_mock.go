...
// Source: github.com/juju/juju/apiserver/facades/client/modelmanager (interfaces: ApplicationService,AccessService,SecretBackendService,ModelService,ServiceFactoryGetter,ModelDefaultsService,ModelInfoService,ModelConfigService,NetworkService,ModelServiceFactory,CloudService)
//
...
func (m *MockServiceFactoryGetter) ServiceFactoryForModel(arg0 model.UUID) modelmanager.ModelServiceFactory {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ServiceFactoryForModel", arg0)
	ret0, _ := ret[0].(modelmanager.ModelServiceFactory)
	return ret0
}

// ServiceFactoryForModel indicates an expected call of ServiceFactoryForModel.
func (mr *MockServiceFactoryGetterMockRecorder) ServiceFactoryForModel(arg0 any) *MockServiceFactoryGetterServiceFactoryForModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ServiceFactoryForModel", reflect.TypeOf((*MockServiceFactoryGetter)(nil).ServiceFactoryForModel), arg0)
	return &MockServiceFactoryGetterServiceFactoryForModelCall{Call: call}
}

// MockServiceFactoryGetterServiceFactoryForModelCall wrap *gomock.Call
type MockServiceFactoryGetterServiceFactoryForModelCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockServiceFactoryGetterServiceFactoryForModelCall) Return(arg0 modelmanager.ModelServiceFactory) *MockServiceFactoryGetterServiceFactoryForModelCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockServiceFactoryGetterServiceFactoryForModelCall) Do(f func(model.UUID) modelmanager.ModelServiceFactory) *MockServiceFactoryGetterServiceFactoryForModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockServiceFactoryGetterServiceFactoryForModelCall) DoAndReturn(f func(model.UUID) modelmanager.ModelServiceFactory) *MockServiceFactoryGetterServiceFactoryForModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockModelServiceFactory) Config() modelmanager.ModelConfigService {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockModelServiceFactoryConfigCall) Return(arg0 modelmanager.ModelConfigService) *MockModelServiceFactoryConfigCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelServiceFactoryConfigCall) Do(f func() modelmanager.ModelConfigService) *MockModelServiceFactoryConfigCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelServiceFactoryConfigCall) DoAndReturn(f func() modelmanager.ModelConfigService) *MockModelServiceFactoryConfigCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// ModelInfo mocks base method.
func (m *MockModelServiceFactory) ModelInfo() modelmanager.ModelInfoService {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockModelServiceFactoryModelInfoCall) Return(arg0 modelmanager.ModelInfoService) *MockModelServiceFactoryModelInfoCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelServiceFactoryModelInfoCall) Do(f func() modelmanager.ModelInfoService) *MockModelServiceFactoryModelInfoCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelServiceFactoryModelInfoCall) DoAndReturn(f func() modelmanager.ModelInfoService) *MockModelServiceFactoryModelInfoCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Network mocks base method.
func (m *MockModelServiceFactory) Network() modelmanager.NetworkService {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockModelServiceFactoryNetworkCall) Return(arg0 modelmanager.NetworkService) *MockModelServiceFactoryNetworkCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelServiceFactoryNetworkCall) Do(f func() modelmanager.NetworkService) *MockModelServiceFactoryNetworkCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelServiceFactoryNetworkCall) DoAndReturn(f func() modelmanager.NetworkService) *MockModelServiceFactoryNetworkCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
